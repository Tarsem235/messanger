  ...
  return (
    <form onSubmit={handleSubmit} className="fixed bottom-0 right-0 border-[1px] border-white border-t-pink-500 border-l-gray-200 w-full  lg:w-[71.5%] px-4 py-3 bg-white ">
      <div className="flex items-center space-x-3 rounded-full">
         <div className="flex items-center rounded-full bg-gray-100 px-4 py-2 shadow-sm ">
        <input
          type="text"
          placeholder="Message..."
          value={message}
          onChange={(e) => setMessage(e.target.value)}
          className= "w-screen flex-1 bg-transparent outline-none text-sm text-gray-800 placeholder-gray-500"
        />
        </div>
          <button
          type="submit"
