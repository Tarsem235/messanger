...
function Left() {
  ...
  return (
    <>
      <div
        className={`fixed inset-0 md:ml-12 md:w-1/4 bg-white text-white font-semibold border-r border-gray-700 shadow-xl h-screen transition-transform duration-300 z-30 ${
